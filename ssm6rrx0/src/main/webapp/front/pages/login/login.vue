<template>
	<view class="content">
		<view class="logo">
			<image :style='{"boxShadow":"0 0 16rpx #59f43e","borderColor":"#ccc","borderRadius":"40rpx","borderWidth":"2rpx","width":"160rpx","borderStyle":"solid","url":"http://codegen.caihongy.cn/20210113/67221fbe18ba4d6fbc4fbc6adba237bd.jpg","isShow":false,"height":"160rpx"}' src='http://codegen.caihongy.cn/20210113/67221fbe18ba4d6fbc4fbc6adba237bd.jpg' mode="aspectFill"></image>
		</view>
		...
		<view class="links">
            ...
            <view>|</view>
                        			            <view class="link-highlight" @tap="onRegisterTap('jiaoshi')" :style='{"color":"rgba(0, 0, 0, 1)","fontSize":"26rpx"}'>注册教师</view>
            <view>|</view>
