          ...
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
                ...
                :value="item">
                        ...
                        <el-col :span="12">
        <el-form-item v-if="flag=='xuesheng'"  label="寝室" prop="qinshi">
          <el-select v-model="ruleForm.qinshi" placeholder="请选择寝室">
            <el-option
                v-for="(item,index) in xueshengqinshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
          ...
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
                ...
                :value="item">
                        ...
                        <el-col :span="12">
        <el-form-item v-if="flag=='jiaoshi'"  label="寝室" prop="qinshi">
          <el-select v-model="ruleForm.qinshi" placeholder="请选择寝室">
            <el-option
                v-for="(item,index) in jiaoshiqinshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
  ...
  data() {
    return {
      ...
      usersFlag: false,
                        ...
                        xueshengqinshiOptions: [],
                                                                                                                        jiaoshixingbieOptions: [],
                        jiaoshiqinshiOptions: [],
                                                                                                                };
  },
  mounted() {
    ...
    this.$http({
      ...
      if (data && data.code === 0) {
        this.xueshengqinshiOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
      ...
      if (data && data.code === 0) {
        this.jiaoshiqinshiOptions = data.data;
      } else {
        this.$message.error(data.msg);
      }
    });
