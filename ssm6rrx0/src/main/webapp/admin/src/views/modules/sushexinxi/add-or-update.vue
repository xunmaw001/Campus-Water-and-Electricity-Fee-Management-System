<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宿舍楼号" prop="sushelouhao">
          <el-input v-model="ruleForm.sushelouhao" 
              placeholder="宿舍楼号" clearable  :readonly="ro.sushelouhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宿舍楼号" prop="sushelouhao">
              <el-input v-model="ruleForm.sushelouhao" 
                placeholder="宿舍楼号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.susheleixing"
                placeholder="宿舍类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="宿舍类别" prop="susheleibie">
          <el-select v-model="ruleForm.susheleibie" placeholder="请选择宿舍类别">
            <el-option
                v-for="(item,index) in susheleibieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="宿舍类别" prop="susheleibie">
	      <el-input v-model="ruleForm.susheleibie"
                placeholder="宿舍类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宿舍名称" prop="sushemingcheng">
          <el-input v-model="ruleForm.sushemingcheng" 
              placeholder="宿舍名称" clearable  :readonly="ro.sushemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宿舍名称" prop="sushemingcheng">
              <el-input v-model="ruleForm.sushemingcheng" 
                placeholder="宿舍名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="宿舍状态" prop="sushezhuangtai">
          <el-select v-model="ruleForm.sushezhuangtai" placeholder="请选择宿舍状态">
            <el-option
                v-for="(item,index) in sushezhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="宿舍状态" prop="sushezhuangtai">
	      <el-input v-model="ruleForm.sushezhuangtai"
                placeholder="宿舍状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
